...
build-1586059007: ../uart_echo_interrupts_standby.syscfg
	@echo 'Building file: "$<"'
	@echo 'Invoking: SysConfig'
	"C:/ti/ccs2020/ccs/utils/sysconfig_1.24.0/sysconfig_cli.bat" --script "C:/IT/dianji(1)/2026.8266.EXP/uart_echo_interrupts_standby.syscfg" -o "." -s "C:/ti/mspm0_sdk_2_05_01_00/.metadata/product.json" --compiler ticlang
	@echo 'Finished building: "$<"'
	@echo ' '

device_linker.cmd: build-1586059007 ../uart_echo_interrupts_standby.syscfg
device.opt: build-1586059007
device.cmd.genlibs: build-1586059007
ti_msp_dl_config.c: build-1586059007
ti_msp_dl_config.h: build-1586059007
Event.dot: build-1586059007
